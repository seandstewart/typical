...
from typical.types import dsn, email, frozendict, path, secret, url
...
slotted = typical.classes.slotted(dict=False, weakref=True)
...
SCHEMA_FIELD_FORMATS = typical.inspection.TypeMap(
    {
