...
class ConstraintsFactory:
    ...
    def build(
        ...
        **config,
    ) -> structs.AbstractConstraintValidator:
        if t in self.NOOP:
        ...
        if t is cls or t in self.__visited:
            return structs.DelayedConstraintValidator(
                ref=t,
                localns={},
                globalns={},
                nullable=nullable,
    ...
    def _from_undeclared_type(
        ...
        *,
        ...
        return engine.ConstraintValidator(
            constraints=structs.UndeclaredTypeConstraints(
    ...
    def _from_strict_type(
        ...
        *,
        ...
        constraints = structs.TypeConstraints(
            type=t,
            nullable=nullable,
            readonly=readonly,
            writeonly=writeonly,
    ...
    def _from_text_type(
        ...
        **config,
        ...
        constraints = structs.TextConstraints(  # type: ignore[type-var]
            type=t,
            nullable=nullable,
            readonly=readonly,
            writeonly=writeonly,
    ...
    def _from_number_type(
        ...
        **config,
        ...
        return_if_instance = not config
        constraints: structs.NumberConstraints
        if is_decimal:
            constraints = structs.DecimalConstraints(
    ...
    def _from_array_type(
        ...
        *,
        ...
        cls: type | None | ... = ...,  # type: ignore[misc]
        default: Hashable | Callable[[], VT] | constants.empty = constants.empty,
        values: structs.AbstractConstraintValidator = None,
        **config,
    ...
    def _from_mapping_type(
        ...
        *,
        ...
        readonly: bool = False,
        writeonly: bool = False,
        keys: structs.AbstractConstraintValidator = None,
        values: structs.AbstractConstraintValidator = None,
        cls: type | None | ... = ...,  # type: ignore[misc]
        default: Hashable | Callable[[], VT] | constants.empty = constants.empty,
        **config,
        ...
        origin = inspection.origin(t)
        constraints = structs.MappingConstraints(
            type=origin,
    ...
    def _from_union_type(
        ...
        *,
        ...
        ut = inspection.flatten_union(t)  # type: ignore[arg-type]
        nullable = nullable or checks.isoptionaltype(ut)  # type: ignore[arg-type]
        args = inspection.get_args(ut)
        args_cvs = [self.build(a, cls=cls) for a in args]
        tag = inspection.get_tag_for_types(args)
    ...
    def _from_literal_type(
        ...
        *,
        ...
        constraints = structs.EnumerationConstraints(
            type=t,
            nullable=nullable,
            readonly=readonly,
            writeonly=writeonly,
    ...
    def _from_user_type(
        ...
        *,
        ...
        sig = inspection.cached_signature(t)
        hints = inspection.cached_type_hints(t)
        params = {**sig.parameters}
        items: dict[str, structs.AbstractConstraintValidator] = {}
        fields: dict[str, structs.AbstractConstraints] = {}
        required: list[str] = []
        istypeddict = checks.istypeddict(t)
        ot = inspection.origin(t)
        if istypeddict:
            ot = dict
        fcv: structs.AbstractConstraintValidator
        ...
        constraints = structs.StructuredObjectConstraints(
            type=t,
            origin=ot,
            nullable=nullable,
            readonly=readonly,
...
class ConstrainedType(Generic[VT]):
    __constraints__: structs.AbstractConstraintValidator[VT]
    __parent__: type[VT]
    __args__: tuple[type, ...]
