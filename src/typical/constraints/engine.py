...
class ConstraintValidator(structs.AbstractConstraintValidator[VT]):
...
class ArrayConstraintValidator(
    BaseContainerValidator[_AVT, structs.AbstractConstraintValidator[_IVT]]
):
    constraints: structs.ArrayConstraints
    validator: validators.ValidatorProtocol
...
class BaseStructuredObjectConstraintValidator(
    structs.AbstractContainerValidator[VT, _ICV]
):
    def validate_fields(
...
class StructuredObjectConstraintValidator(
    BaseStructuredObjectConstraintValidator[
        VT, Mapping[str, structs.AbstractConstraintValidator[_IVT]]
    ]
):
    constraints: structs.StructuredObjectConstraints[VT]
    validator: _StructuredValidatorT[VT]
    items: Mapping[str, structs.AbstractConstraintValidator[_IVT]]
...
class StructuredTupleConstraintValidator(
    BaseStructuredObjectConstraintValidator[
        _TT, "tuple[structs.AbstractConstraintValidator, ...]"
    ]
):
    constraints: structs.StructuredObjectConstraints[_TT]
    validator: _StructuredValidatorT[_TT]
    items: tuple[structs.AbstractConstraintValidator, ...]
...
class _KVMappingEntryValidator(AbstractEntryConstraintValidator[_FT, VT]):
    ...
    def __init__(self, cv: structs.AbstractConstraintValidator):
        self.cv = cv
...
class MappingConstraintValidator(
    ...
    constraints: structs.MappingConstraints[_MT]
...
class AbstractMultiConstraintValidator(
    structs.AbstractConstraintValidator, Generic[VT]
):
    __slots__ = (
        "constraints",
        "cvs",
    ...
    constraints: structs.MultiConstraints[VT]

    def __init__(
        self,
        constraints: structs.MultiConstraints,
        constraint_validators: tuple[structs.AbstractConstraintValidator, ...],
    ):
        self.constraints = constraints
...
class SimpleMultiConstraintValidator(AbstractMultiConstraintValidator[VT]):
    def validate(
        ...
        cv: structs.AbstractConstraintValidator | None = self.cvs_by_type.get_by_parent(
            value.__class__
        )
...
class TaggedMultiConstraintValidator(AbstractMultiConstraintValidator[VT]):
    def validate(
        ...
        cv: structs.AbstractConstraintValidator[VT] = self.cvs_by_tag[tag_value]
