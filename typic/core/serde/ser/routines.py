...
from typic.core.interfaces import Annotation, PrimitiveT

if TYPE_CHECKING:
    from typic.core.interfaces import SerializerT
            ...
            def nullable_stdlib_check(
                ...
                *,
                ...
                raise SerializationValueError(
                    f"{address}: "
                    f"type {otname!r} is not a subtype of type {__qualname!r}."
                    "Perhaps this annotation should be '{__qualname} | {otname}'"
                )
