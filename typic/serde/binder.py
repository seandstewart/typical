...
from .obj import SerdeProtocol, SerdeProtocolsT, BoundArguments  # noqa: F401
from ..common import (
    EMPTY,
    POSITIONAL_ONLY,
    RETURN_KEY,
    ...
    def bind(
        ...
        **kwargs
        ...
        Traceback (most recent call last):
            ...
        typic.constraints.common.error.ConstraintValueError: Given value <3.0> fails constraints: (type=int, nullable=False, coerce=False)
        """
